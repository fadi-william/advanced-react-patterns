...
const ToggleOff: React.StatelessComponent<ICompoundChildrenProps> = (
  { children },
  context: IToggleContext
) => {
  const { on } = context[TOGGLE_CONTEXT];
...
const ToggleButton: React.StatelessComponent<ICompoundChildrenProps> = (
  props,
  context: IToggleContext
) => {
...
class FexibleCompoundToggle extends React.Component<
  IFlexibleCompundProps,
  IFlexibleCompundState
> {
