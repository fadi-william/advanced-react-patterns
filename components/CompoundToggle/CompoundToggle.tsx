...
class CompoundToggle extends React.Component<ICompoundToggleProps, ICompoundToggleState> {
    ...
    public render() {
        ...
        const children = React.Children.map(
            this.props.children,
            (child) => React.cloneElement(child as React.ReactElement<ICompoundChildrenProps | any>, {
                on: this.state.on,
