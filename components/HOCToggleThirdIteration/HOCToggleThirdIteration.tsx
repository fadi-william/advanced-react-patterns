...
export const withToggle = (Component: React.StatelessComponent<ICompoundChildrenProps>) => {
...
const ToggleOn: React.StatelessComponent<ICompoundChildrenProps> = withToggle(({ children, tog }) => {
    return tog.on ? children : null;
});

const ToggleOff: React.StatelessComponent<ICompoundChildrenProps> = withToggle(({ children, tog }) => {
    return tog.on ? null : children;
});

const ToggleButton: React.StatelessComponent<ICompoundChildrenProps> = withToggle(({ tog, ...props}) => {
...
class FexibleCompoundToggleWithHOC extends React.Component<ITCTWHOCProps, ITCTWHOCState> {
