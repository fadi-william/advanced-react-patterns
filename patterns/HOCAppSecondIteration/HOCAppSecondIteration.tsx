...
import HOCToggleSecondIteration,
    { ICompoundChildrenProps } from "../../components/HOCToggleSecondIteration/HOCToggleSecondIteration";
...
class HOCAppSecondIteration extends React.Component {
    ...
    public render() {
        ...
        const ToggleComponent: React.StatelessComponent<ICompoundChildrenProps> =
        ...
        const MyEventComponent: React.StatelessComponent<ICompoundChildrenProps & IMyEventComponentProps> =
