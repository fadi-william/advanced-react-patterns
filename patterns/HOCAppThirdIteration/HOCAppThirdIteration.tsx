...
import HOCToggleThirdIteration,
    { ICompoundChildrenProps } from "../../components/HOCToggleThirdIteration/HOCToggleThirdIteration";
...
class HOCAppThirdIteration extends React.Component {
    ...
    public render() {
        ...
        const MyCustomButtonComponent =
            ({tog: {on, onClick }, innerRef}) => (
            <ToggleButton on={on} toggle={onClick} ref={innerRef} />
        );

        const ToggleComponent =
            HOCToggleThirdIteration.withToggle( ({tog: {on, onClick }, innerRef}) => (
                <ToggleButton on={on} toggle={onClick} ref={innerRef} />
            ));
